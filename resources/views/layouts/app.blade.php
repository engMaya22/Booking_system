...
<body   class="font-sans antialiased" style="background:url({{asset('img/booking.jfif')}}) no-repeat;  background-size: cover" >
    ...
    <main class="max-w-3xl min-h-screen p-8 mx-auto mt-16 bg-white shadow-md">
        ...
        <div class="flex justify-center mb-4">
            <img src="{{ asset('img/logo/car.png') }}" alt="CarLogo" class="w-36">
        </div>
